...
object SearchLogic {
    private val aliases: Map<String, Set<String>> = mapOf(
        ...
        "chaussette" to setOf("sock"), "chaussettes" to setOf("sock"),
        "imprimante" to setOf("printer"),
        "radiateur" to setOf("radiator", "heater"), "chauffage" to setOf("radiator", "heater"),
        ...
        "chien" to setOf("dog"), "lapin" to setOf("rabbit"),
        "peluche" to setOf("stuffed animal", "plush toy", "teddy bear"),
        "peluche lapin" to setOf("stuffed animal", "plush toy", "rabbit", "teddy bear"),
        "poupee" to setOf("doll"),
        ...
        "outil" to setOf("tool"), "outils" to setOf("tool"),
        "caisse a outils" to setOf("toolbox", "tool box", "tool chest"),
        "boite a outils" to setOf("toolbox", "tool box", "tool chest"),
